...
public class Librarymanagement {
	...
	private static void fetch() {
		Librarydatabase.getInstance().readUser();
		Librarydatabase.getInstance().readBook();
		Librarydatabase.getInstance().readBorrowed();
		Librarydatabase.getInstance().readLibrary();
	}
}
